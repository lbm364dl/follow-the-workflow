...
Most "Quarto syntax" is nothing new. It's based on something called [Markdown](https://www.markdownguide.org/getting-started/). Anyway, if you're interested in knowing more, go read something like [Quarto's Markdown basics](https://quarto.org/docs/authoring/markdown-basics.html).
...
Welcome to LaTeX math formulas. Yes, we're in Quarto, but we still use LaTeX syntax for math formulas. So you'll need to learn how to do that. No, this won't be a [LaTeX math guide](https://www.overleaf.com/learn/latex/Mathematical_expressions). Ask your favorite AI or something.

## Quarto runs my code?!

Yes! That's one of the best features. You can include code blocks in Quarto files, and they will be executed and their output included in the final document. You can also choose if you want to include only code, only output, or both.
